...
struct cyg_nbb
{
	cyg_uint32 uc; // Update counter
	cyg_uint32 last_uc; // Last update counter
	cyg_uint32 ac; // Acknowledge counter
	cyg_uint32 last_ac; // Last acknowledge counter
	cyg_threadqueue     get_threadq;    /* Queue of waiting threads          */
	cyg_threadqueue     put_threadq;    /* Queue of waiting threads          */
	void *              itemqueue[ CYGNUM_KERNEL_SYNCH_NBB_QUEUE_SIZE ];
};
